...
CREATE TABLE users (
    ...
    CONSTRAINT fk_user_role FOREIGN KEY (role_id) REFERENCES user_roles(id) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
INSERT INTO users (nickname, email, steam_level, hours_played, last_online, is_online, role_id) VALUES 
