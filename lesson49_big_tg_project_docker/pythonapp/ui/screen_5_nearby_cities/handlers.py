...
def callback_screen_5_nearby_cities_handler(
    ...
    # Сразу подтверждаем callback-запрос серверу Telegram, чтобы индикатор
    # загрузки исчез у пользователя.
    ...
    try:
        ...
        # Сообщаем об ошибке сохранения, не останавливая polling бота.
        bot.send_message(
            call.message.chat.id,
